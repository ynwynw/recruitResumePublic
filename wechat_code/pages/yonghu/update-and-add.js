...
if(o=='dianhuahaoma'){
refobjempty["dianhuahaoma"]=obj[o]
ro.dianhuahaoma = true;
continue;
}else{
}
...
dianhuahaoma: this.data. dianhuahaoma,
}
...
const valuedianhuahaoma = this.data.dianhuahaoma;

if (!mobilePattern.test(valuedianhuahaoma)) {
wx.showToast({
icon: "none",
title: `电话号码应输入手机格式`,
})
